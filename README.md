...
The documentation of the (1) input data, configuration options and output files and (2) the complete code can be found for the current version inside the main branch as on [this page](https://danielrenebayer.github.io/UrbanFireXDT/index.html).

The installation procedure is described below on this page.
...
- The directory `documentation` contains the complete input and output documentation as well as a documentation of all configuration variables; the [documentation](https://danielrenebayer.github.io/UrbanFireXDT/index.html) is autogenerated from this directory.
