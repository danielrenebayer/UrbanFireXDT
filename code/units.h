...
class Substation {
    ...
    public:
        ...
        double get_current_PV_feedin_to_grid_kW()      const { return pv_gen_kW;     } ///< Returns the current feed-in into the grid in kW that is generated by all connected PV installations
        double get_current_BS_feedin_to_grid_kW()      const { return bs_gen_kW;     } ///< Returns the current feed-in into the grid in kW that is generated by all connected battery storage systems
        double get_current_CHP_feedin_to_grid_kW()     const { return chp_gen_kW;    } ///< Returns the current feed-in into the grid in kW that is generated by all connected CHPs
        double get_current_wind_feedin_to_grid_kW()    const { return wind_gen_kW;   } ///< Returns the current feed-in into the grid in kW that is generated by all connected wind turbines
        double get_current_unknown_feedin_to_grid_kW() const { return unknown_gen_kW;} ///< Returns the current feed-in into the grid in kW that is generated by unknown components or not attributable to any generation technology
    ...
    private:
        ...
        double pv_gen_kW;      ///< PV generation in kW at a single time step
        double bs_gen_kW;      ///< battery storage feed-in (to the grid) at a single time step
        double chp_gen_kW;     ///< CHP power generation in kW at a single time step
        double wind_gen_kW;    ///< Wind power generation in kW at a single time step
        double unknown_gen_kW; ///< Power generation in kW at a single time step caused by not attributable or unknown generation technologies
        //
