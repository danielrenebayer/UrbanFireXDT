...
class Substation : BaseUnit<Substation> {
    ...
    public:
        ...
        double get_residential_demand() const { return resident_demand; } ///< Returns the accumulated demand (i.e., only the positive virtual smart meter readings) of all residential control units at this substation in kW
        double get_other_demand()       const { return other_demand;    } ///< Returns the accumulated demand (i.e., only the positive virtual smart meter readings) of all non-residential control units at this substation in kW
    ...
    private:
        ...
        double other_demand;    ///< Demand (not load!) caused by non-residential buildings
