...
namespace global {
    ...
    inline std::vector<struct tm*>* time_localtime_str     = NULL; ///< Reference to the list of the time as struct tm; Attention: These labels should be right-aligned, i.e., the time at time step [ts-1] denotes the ending of the interval - alignment fits to time_timestep_id
