...
| expansion BS power computation mode | string | yes |  | Power as given<br>Use E:P-ratio | If set to ‘Use E:P ratio’ the variable ‘expansion BS P in kW’ will be ignored, instead P will be E / this variable | no |
